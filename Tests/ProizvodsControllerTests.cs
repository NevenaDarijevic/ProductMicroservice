...
namespace Tests
{
    public class ProizvodsControllerTests : IDisposable
    {
        Mock<IProizvodRepozitorijum> mockRepo;
        ProizvodsProfile realProfile;
        MapperConfiguration configuration;
        IMapper mapper;

        public ProizvodsControllerTests()
        {
            mockRepo = new Mock<IProizvodRepozitorijum>();
            realProfile = new ProizvodsProfile();
        ...
        public void GetAllProducts_ReturnsZeroResources_WhenDBIsEmpty()
        {
            //Arrange 
            mockRepo.Setup(repo =>
              repo.VratiProizvode()).Returns(GetProizvod(0));
        ...
        private List<Proizvod> GetProizvods(int num)
        {
